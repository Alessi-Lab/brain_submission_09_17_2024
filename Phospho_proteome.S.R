...
contrast.matrix <- makeContrasts(L2PD.G2019S-Control.., levels=design)
fit2 <- contrasts.fit(fit, contrast.matrix)
fit2 <- eBayes(fit2)
result <- topTable(fit2, coef=1, number=Inf, sort.by = "none")
fin.df <- cbind(rowData(d[[4]]), result)
write.table(fin.df, "H:/20230713_143813_22_phospho_no-norm_Report.output.de.0.3.S.L2PD.G2019S-Control.tsv", sep="\t", row.names = FALSE)
contrast.matrix <- makeContrasts(L2NMC.G2019S-Control.., levels=design)
fit2 <- contrasts.fit(fit, contrast.matrix)
fit2 <- eBayes(fit2)
result <- topTable(fit2, coef=1, number=Inf, sort.by = "none")
fin.df <- cbind(rowData(d[[4]]), result)
write.table(fin.df, "H:/20230713_143813_22_phospho_no-norm_Report.output.de.0.3.S.L2NMC.G2019S-Control.tsv", sep="\t", row.names = FALSE)
contrast.matrix <- makeContrasts(L2PD.G2019S-L2NMC.G2019S, levels=design)
fit2 <- contrasts.fit(fit, contrast.matrix)
fit2 <- eBayes(fit2)
result <- topTable(fit2, coef=1, number=Inf, sort.by = "none")
fin.df <- cbind(rowData(d[[4]]), result)
write.table(fin.df, "H:/20230713_143813_22_phospho_no-norm_Report.output.de.0.3.S.L2PD.G2019S-L2NMC.G2019S.tsv", sep="\t", row.names = FALSE)
contrast.matrix <- makeContrasts(L2PD.G2019S-iPD.., levels=design)
fit2 <- contrasts.fit(fit, contrast.matrix)
fit2 <- eBayes(fit2)
result <- topTable(fit2, coef=1, number=Inf, sort.by = "none")
fin.df <- cbind(rowData(d[[4]]), result)
write.table(fin.df, "H:/20230713_143813_22_phospho_no-norm_Report.output.de.0.3.s.L2PD.G2019S-iPD.tsv", sep="\t", row.names = FALSE)
contrast.matrix <- makeContrasts(iPD..-Control.., levels=design)
fit2 <- contrasts.fit(fit, contrast.matrix)
fit2 <- eBayes(fit2)
result <- topTable(fit2, coef=1, number=Inf, sort.by = "none")
fin.df <- cbind(rowData(d[[4]]), result)
write.table(fin.df, "H:/20230713_143813_22_phospho_no-norm_Report.output.de.0.3.S.iPD-Control.tsv", sep="\t", row.names = FALSE)
...
write.table(raw.df, "H:/20230713_143813_22_phospho_no-norm_Report.output.S.raw.tsv", sep="\t", row.names = FALSE)