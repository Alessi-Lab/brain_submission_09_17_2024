...
setnames(a, old=colnames(e)[2:70], new=rename.cols)
...
setnames(normalized.df, old=colnames(normalized.df)[2:70], new=rename.cols)

write.table(normalized.df, "H:/20230905_150637_Total_Proteome.wide.protein.quant.b.normalized.0.7.tsv", sep="\t", row.names = FALSE)
...
write.table(cbind(rowData(d[[4]]), result), "H:/20230905_150637_Total_Proteome.wide.protein.quant.de.0.7.b.tsv", sep="\t", row.names = FALSE)
write.table(a, "H:/20230905_150637_Total_Proteome.wide.protein.quant.raw.b.tsv", sep="\t", row.names = FALSE)