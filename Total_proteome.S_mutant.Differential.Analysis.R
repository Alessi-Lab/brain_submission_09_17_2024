...
library(data.table)
setnames(e, old=colnames(e)[2:51], new=rename.cols)
...
write.table(cbind(rowData(d[[4]]), result), "H:/20230905_150637_Total_Proteome.wide.protein.quant.de.0.7.s.mutant.tsv", sep="\t", row.names = FALSE)
