...
write.table(normalized.df, "H:/20230713_143813_22_phospho_no-norm_Report.output.B.normalized.tsv", sep="\t", row.names = FALSE)
...
write.table(fin.df, "H:/20230713_143813_22_phospho_no-norm_Report.output.de.0.3.B.iPD-Control.tsv", sep="\t", row.names = FALSE)
...
write.table(raw.df, "H:/20230713_143813_22_phospho_no-norm_Report.output.B.raw.tsv", sep="\t", row.names = FALSE)