...
write.table(normalized.df, "H:/20230713_143813_22_phospho_no-norm_Report.output.meta.normalized.tsv", sep="\t", row.names = FALSE)
library("limma")
...
write.table(fin.df, "H:/20230713_143813_22_phospho_no-norm_Report.output.de.0.3L2PD.G2019S-iPD.tsv", sep="\t", row.names = FALSE)
...
write.table(raw.df, "H:/20230713_143813_22_phospho_no-norm_Report.output.raw.tsv", sep="\t", row.names = FALSE)