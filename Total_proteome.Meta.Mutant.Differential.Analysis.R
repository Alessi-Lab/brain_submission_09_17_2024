...
library(data.table)
setnames(e, old=colnames(e)[2:156], new=rename.cols)
...
write.table(cbind(rowData(d[[4]]), result), "H:/20230905_150637_Total_Proteome.wide.protein.quant.de.0.7.meta.mutant.tsv", sep="\t", row.names = FALSE)
write.table(e, "H:/20230905_150637_Total_Proteome.wide.protein.quant.mutant.control.ipd.meta.raw.tsv", sep="\t", row.names = FALSE)